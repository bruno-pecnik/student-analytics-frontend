...
import KomponenteTab from '../components/admin/KomponenteTab';
...
function AdminPage() {
  const items = [
    { key: '1', label: 'Korisnici', children: <KorisniciTab /> },
    ...
    { key: '6', label: 'Komponente ocjenjivanja', children: <KomponenteTab /> },
  ];
